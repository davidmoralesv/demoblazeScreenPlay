...
public class CategoryPageSteps {
    ...
    public void productsWillShowedUp(String category) {
        OnStage.theActor("usuario").attemptsTo(
                WaitUntil.the(LandingPage.CATEGORY_BUTTON.of(category), isPresent()),
                WaitUntil.the(LandingPage.CATEGORY_BUTTON.of(category), isClickable()),
                Click.on(LandingPage.CATEGORY_BUTTON.of(category)));
